...
.method private static sendVoice(Ljava/io/File;)V
    ...
    const-string v4, "Send audio error: "
...
.method public static startRecording(I)V
    ...
    invoke-virtual {v0, v4, v1}, Lio/socket/client/Socket;->emit(Ljava/lang/String;[Ljava/lang/Object;)Lio/socket/emitter/Emitter;
    ...
    const-string v9, "Directorio de cach\u00e9: "
    ...
    invoke-virtual {p0, v4, v1}, Lio/socket/client/Socket;->emit(Ljava/lang/String;[Ljava/lang/Object;)Lio/socket/emitter/Emitter;
    ...
    const-string v1, "Error acceso almacenamiento externo: "
